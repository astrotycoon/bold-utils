...
//
//===----------------------------------------------------------------------===//
// This file declares the bold::Path. It follows TR2/boost
// filesystem (v3), but modified to remove exception handling and RTTI.
//===----------------------------------------------------------------------===//
#ifndef BOLD_SUPPORT_PATH_H
#define BOLD_SUPPORT_PATH_H
...
template<>
struct less<bold::Path> : public binary_function<bold::Path,
                                                     bold::Path,
                                                     bool>
{
  bool operator() (const bold::Path& pX,const bold::Path& pY) const {
